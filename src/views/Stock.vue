...
export default {
  ...
  setup() {
    ...
    const toggleCategory = (categoryId) => {
      // Vue'nun reaktifliği için yeni bir nesne oluştur
      const newExpandedState = { ...expandedCategories.value }
      
      // Sadece tıklanan kategorinin durumunu değiştir
